# -*- coding: utf-8 -*-
"""jquants-api-quick-start-en.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/J-Quants/jquants-api-quick-start/blob/master/jquants-api-quick-start-en.ipynb
...
import os
refreshtoken = os.environ['JQ_REFRESH_TOKEN']  #@param {type:"string"}
...
code = "6331"#@param {type:"string"}
date = "20250530"#@param {type:"string"}
...
from_ = "20250301" #@param {type:"string"}
to = "20250501" #@param {type:"string"}
...
#@title Margin Trading Outstanding (Issues Subject to Daily Publication)（/markets/daily_margin_interest）
