...
class TestQueryEngine:
    ...
    def test_get_daily_prices_with_code_filter(self, tmp_path, sample_daily_prices_data):
        ...
        query_engine.conn.register("temp_df", sample_daily_prices_data.to_pandas()); query_engine.conn.execute("CREATE TABLE daily_prices AS SELECT * FROM temp_df")
