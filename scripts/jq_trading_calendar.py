...
def main() -> int:
    parser = argparse.ArgumentParser(description="Fetch trading calendar (/v1/markets/trading_calendar)")
    parser.add_argument("--holidaydivision", choices=["0", "1", "2", "3"], default="", help="Holiday division (optional)")
    ...
    rows = client.get_paginated("/v1/markets/trading_calendar", data_key="trading_calendar", params=params)
